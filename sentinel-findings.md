...
- **Location:** `ENFORTUMAB_UC_REVIEW.html:2364`
...
- **When:** 2026-06-13T11:45:56.600509+00:00

## [WARN] P1-fabrication-orphan-trial
- **Location:** `ENFORTUMAB_UC_REVIEW.html:5080`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ENFORTUMAB_UC_REVIEW.html:5083`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ENFORTUMAB_UC_REVIEW.html:5086`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ENFORTUMAB_UC_REVIEW.html:5089`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ENFORTUMAB_UC_REVIEW.html:16114`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ENFORTUMAB_UC_REVIEW.html:22949`
...
- **Location:** `ENFORTUMAB_UC_REVIEW.html:1`
...
- **When:** 2026-06-13T11:45:56.756349+00:00

## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:29939`
...
- **When:** 2026-06-13T11:45:59.131893+00:00

## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:35202`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:36888`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:36891`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:43856`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:43900`
- **Detail:** `parseInt(r.k) || 0` drops 0/0.0 silently — parsed zero is falsy and falls through to the right-hand fallback
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:45:59.131893+00:00
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:43962`
- **Detail:** `parseInt(r.k) || 0` drops 0/0.0 silently — parsed zero is falsy and falls through to the right-hand fallback
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:45:59.131893+00:00
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:44294`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ENFORTUMAB_UC_REVIEW.html:44312`
...
- **Detail:** pattern matched: * no unfilled build placeholders ({{...}} build tokens, REPLACE_ME, __PLACEHOLDER__)
...
- **When:** 2026-06-13T11:47:55.516756+00:00

## [WARN] P1-unpopulated-placeholder
- **Location:** `test_smoke.py:48`
- **Detail:** pattern matched: # an unfilled build token is a bare `{{name}}` not preceded by `$`.
- **Fix hint:** Populate the placeholder or escape it before shipping. If the braces are intentional template syntax in a non-template file, exclude the file path via the rule's exclude list.

- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:47:55.516795+00:00
...
- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:47:55.516805+00:00
...
- **Fix hint:** verify NCT12345678 against ClinicalTrials.gov; either add it to realData with full extracted fields, or remove the prose citation if it was inherited from a different paper
- **Source:** F:\e156\docs\assurance-standard.md#data-provenance-match  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:47:56.261631+00:00
...
- **Fix hint:** verify the quoted values against the source
- **Source:** F:\e156\docs\assurance-standard.md#data-checking  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:47:56.427284+00:00
...
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:47:58.703181+00:00
...
- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:48:06.587429+00:00
...
- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:48:06.587467+00:00
...
- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:48:06.587476+00:00
...
- **Fix hint:** verify NCT12345678 against ClinicalTrials.gov; either add it to realData with full extracted fields, or remove the prose citation if it was inherited from a different paper
- **Source:** F:\e156\docs\assurance-standard.md#data-provenance-match  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:48:07.322252+00:00
...
- **Fix hint:** verify the quoted values against the source
- **Source:** F:\e156\docs\assurance-standard.md#data-checking  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:48:07.475171+00:00
...
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:48:09.730328+00:00
...
- **Fix hint:** verify NCT12345678 against ClinicalTrials.gov; either add it to realData with full extracted fields, or remove the prose citation if it was inherited from a different paper
- **Source:** F:\e156\docs\assurance-standard.md#data-provenance-match  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:48:26.177188+00:00
...
- **Fix hint:** verify the quoted values against the source
- **Source:** F:\e156\docs\assurance-standard.md#data-checking  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:48:26.363705+00:00
...
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:48:28.617500+00:00
